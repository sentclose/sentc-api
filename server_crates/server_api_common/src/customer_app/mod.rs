...
use crate::customer_app::app_entities::{AppData, AuthWithToken};
...
pub fn get_app_options<'a>(app_id: impl Into<AppId> + 'a) -> impl Future<Output = AppRes<AppOptions>> + 'a
{
	app_model::get_app_options(app_id)
}
