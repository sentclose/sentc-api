...
use crate::customer_app::app_entities::{AppCustomerAccess, CUSTOMER_OWNER_TYPE_GROUP, CUSTOMER_OWNER_TYPE_USER};
...
{
	//Take care to change also the get app option in the common crate
