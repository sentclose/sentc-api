...
impl ApiErrorCodes
{
	pub fn get_int_code(&self) -> u32
	{
		match self {
			...
			ApiErrorCodes::GroupTooManyKeys => 304,
			ApiErrorCodes::GroupKeySession => 305,
			ApiErrorCodes::GroupInviteNotFound => 306,
			ApiErrorCodes::GroupOnlyOneAdmin => 307,
			ApiErrorCodes::GroupJoinReqNotFound => 308,
			ApiErrorCodes::GroupAccess => 309,
			...
			ApiErrorCodes::GroupUserKick => 314,
			ApiErrorCodes::GroupUserKickRank => 315,
