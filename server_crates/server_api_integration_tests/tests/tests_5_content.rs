...
async fn test_21_create_groups()
{
	...
	let group_input = TestGroup::prepare_create(&child_group_data.1[0].public_group_key).unwrap();
	...
	let group_input = TestGroup::prepare_create(&group_1_keys.public_group_key).unwrap();
